...
public abstract class Car implements Vehicle {
	...
	public final void start() {
		if (gear == 0) {
			...
			System.out.println("Error: The car is not in neutral.");
			System.exit(0);
		}		
	}
	...
	public void stop() {
		gear = 0;
		System.out.println("Car stopped. On this run it has used " + consumption + "l of fuel and it has polluted "+ pollution + "g of CO2.");
	}
	...
	public void drive(double km) {
		...
		if (this.availableFuel > 0) {
			...
			System.out.println("Error: The car is out of fuel.");
			System.exit(0);
		}
	}
